...
def bac():
    ...
    print("=======================")
    print("Access control enforces policy such that users cannot act outside of their intended permissions.")
    print("Failures typically lead to unauthorized information disclosure, modification, or destruction of all data or performing a business function outside the user's limits.")
...
def adminPanel():
    ...
    print("=======================")
    time.sleep(2)
    print("Well let's just don't do it like this, but the key part to remember:")
    ...
    print("But what about companies, a normal employee having access to management features, or what if a normal person can access the database?")
    time.sleep(3)
    global adminpanel_launch
    adminpanel_launch = 1
    owasp.owaspTop10()
